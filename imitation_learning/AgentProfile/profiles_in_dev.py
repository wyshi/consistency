...
import itertools
from imitation_learning.AgentProfile.core import SystemAct, UserAct
...
from imitation_learning.utils import toNumReg
...
class GlobalProfile(object):
    ...
    def regex_label(self, model_clf, sys_texts, which_task, context=None, past=None):
        """
        regex to re-label 
        vs 
        QA    to re-label
            ...
            if "A" in which_task:
                if predicted_label in ["task-related-inquiry", "personal-related-inquiry"]:#, "have-you-heard-of-the-org"]:
                    ...
                    if "?" in sent or re.search(self.greeting_re, utt) or "how" in sent:
                        ...
                        label = UserAct.greeting_inquiry #"simple-greeting"
                    else:
