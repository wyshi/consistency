...
model_A_device_list = ["cuda:3", "cuda:4"]
split_into_A = len(model_A_device_list)

model_B_device = "cuda:2"
...
mode = (
    interactive_mode  # self_play_mode# interactive_mode#self_play_mode#interactive_mode
)

max_sequence_len = 200
model_size = "medium"
use_old_model = True
old_medium_model_dir = (
